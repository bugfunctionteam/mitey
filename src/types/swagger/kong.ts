...
export namespace Idp {
  ...
  export namespace GetAuthenticationUsingPost {
    export type RequestParams = {};
    export type RequestQuery = { username?: string; password?: string; grant_type?: string };
    export type RequestBody = never;
    export type RequestHeaders = {};
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: axiosConfig.baseURL || "https://localhost:8443" });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  idp = {
     ...
     * @request POST:/idp/oauth/token
     */
    getAuthenticationUsingPost: (
      query?: { username?: string; password?: string; grant_type?: string },
